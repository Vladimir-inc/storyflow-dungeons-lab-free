...
import { K as pinsForType, L as humanizeType, N as isKnownNodeType, O as NODE_TYPES, P as registerCommentNode, Q as nodeColor, R as cleanPayload, j as dateFromWorldTime } from "./module-C_DMsB8l.js";
...
const _LLink = class _LLink {
  ...
  static getReroutes(network, linkSegment) {
    ...
    return ((_a = network.reroutes.get(linkSegment.parentId)) == null ? void 0 : _a.getReroutes()) ?? [];
  }
  ...
  static getOriginNode(network, linkId) {
    var _a;
    const id = (_a = network.links.get(linkId)) == null ? void 0 : _a.origin_id;
  ...
  static getTargetNode(network, linkId) {
    var _a;
    const id = (_a = network.links.get(linkId)) == null ? void 0 : _a.target_id;
    return network.getNodeById(id) ?? void 0;
  }
  /**
  ...
  static resolve(linkId, network) {
    var _a;
    return (_a = network.getLink(linkId)) == null ? void 0 : _a.resolve(network);
  }
  /**
  ...
  static resolveMany(linkIds, network) {
    ...
    for (const id of linkIds) {
      const r = (_a = network.getLink(id)) == null ? void 0 : _a.resolve(network);
  ...
  resolve(network) {
    ...
    const input = inputNode == null ? void 0 : inputNode.inputs[this.target_slot];
    const subgraphInput = this.originIsIoNode ? (_a = network.inputNode) == null ? void 0 : _a.slots[this.origin_slot] : void 0;
    if (subgraphInput) {
    ...
    const output = outputNode == null ? void 0 : outputNode.outputs[this.origin_slot];
    const subgraphOutput = this.targetIsIoNode ? (_b = network.outputNode) == null ? void 0 : _b.slots[this.target_slot] : void 0;
    if (subgraphOutput) {
...
_color = new WeakMap();
__publicField(_LLink, "_drawDebug", false);
let LLink = _LLink;
...
const _Rectangle = class _Rectangle extends Float64Array {
  ...
  static from([x2, y, width2, height]) {
    return new _Rectangle(x2, y, width2, height);
  }
  /**
  ...
  static fromCentre([x2, y], width2, height = width2) {
    ...
    return new _Rectangle(left, top, width2, height);
  }
  static ensureRect(rect) {
    return rect instanceof _Rectangle ? rect : new _Rectangle(rect[0], rect[1], rect[2], rect[3]);
  }
   ...
   */
  get pos() {
    __privateGet(this, _pos) ?? __privateSet(this, _pos, this.subarray(0, 2));
   ...
   */
  get size() {
    __privateGet(this, _size) ?? __privateSet(this, _size, this.subarray(2, 4));
  ...
  clone() {
    return new _Rectangle(this[0], this[1], this[2], this[3]);
  }
...
function getNodeInputOnPos(node2, x2, y) {
  ...
  for (const [index, input] of inputs.entries()) {
    ...
    const nameLength = ((_a = input.label) == null ? void 0 : _a.length) ?? ((_b = input.localized_name) == null ? void 0 : _b.length) ?? ((_c = input.name) == null ? void 0 : _c.length);
...
class LGraphIcon {
  constructor({
    ...
    __publicField(this, "unicode");
    __publicField(this, "fontFamily");
    __publicField(this, "color");
    __publicField(this, "bgColor");
    __publicField(this, "fontSize");
    __publicField(this, "circlePadding");
    __publicField(this, "xOffset");
    __publicField(this, "yOffset");
...
class LGraphBadge {
  ...
  get visible() {
    var _a;
    return (((_a = this.text) == null ? void 0 : _a.length) ?? 0) > 0 || !!this.icon;
  }
  getWidth(ctx) {
...
class LGraphButton extends LGraphBadge {
  constructor(options) {
    ...
    __publicField(this, "_last_area", new Rectangle());
...
function strokeShape(ctx, area, {
  ...
  round_radius ?? (round_radius = LiteGraph.ROUND_RADIUS);
  color ?? (color = LiteGraph.NODE_BOX_OUTLINE_COLOR);
...
class SlotBase {
  constructor(name, type, boundingRect) {
    ...
    __publicField(this, "_floatingLinks");
...
class NodeSlot extends SlotBase {
  constructor(slot, node2) {
    ...
    __privateAdd(this, _NodeSlot_instances);
    __publicField(this, "pos");
    __privateAdd(this, _node);
    Object.assign(this, rest);
    __privateSet(this, _node, node2);
  }
  get node() {
  ...
  draw(ctx, {
    ...
    const pos = __privateGet(this, _NodeSlot_instances, centreOffset_get);
...
_NodeSlot_instances = new WeakSet();
centreOffset_get = function() {
...
_node = new WeakMap();
const _LGraphGroup = class _LGraphGroup {
...
let LGraphGroup = _LGraphGroup;
const _Reroute = class _Reroute {
  /**
  ...
  constructor(id, network, pos, parentId, linkIds, floatingLinkIds) {
    __privateAdd(this, _Reroute_instances);
    ...
    __privateAdd(this, _pos2, __privateGet(this, _malloc).subarray(0, 2));
    /** @inheritdoc */
    __publicField(this, "selected");
    ...
    __privateAdd(this, _inputSlot, new RerouteSlot(this, true));
    __privateAdd(this, _outputSlot, new RerouteSlot(this, false));
    this.id = id;
  ...
  static get slotOffset() {
    const gap = _Reroute.slotRadius * 0.33;
    return _Reroute.radius + gap + _Reroute.slotRadius;
  }
  get parentId() {
  ...
  /** @inheritdoc */
  get pos() {
    return __privateGet(this, _pos2);
  }
  set pos(value) {
    ...
    __privateGet(this, _pos2)[0] = value[0];
    __privateGet(this, _pos2)[1] = value[1];
  }
  /** @inheritdoc */
  get boundingRect() {
    const { radius } = _Reroute;
    const [x2, y] = __privateGet(this, _pos2);
  ...
  get isInputHovered() {
    return __privateGet(this, _inputSlot).hovering;
  }
  get isOutputHovered() {
    return __privateGet(this, _outputSlot).hovering;
  }
  get firstLink() {
    var _a;
  ...
  findSourceOutput() {
    ...
    if (!link) return;
    const node2 = (_a = __privateGet(this, _network).deref()) == null ? void 0 : _a.getNodeById(link.origin_id);
    if (!node2) return;
    return {
      node: node2,
  ...
  setFloatingLinkOrigin(node2, output, index) {
    ...
    output._floatingLinks ?? (output._floatingLinks = /* @__PURE__ */ new Set());
    for (const link of floatingOutLinks) {
      output._floatingLinks.add(link);
      (_c = (_b = (_a = network == null ? void 0 : network.getNodeById(link.origin_id)) == null ? void 0 : _a.outputs[link.origin_slot]) == null ? void 0 : _b._floatingLinks) == null ? void 0 : _c.delete(link);
  ...
  /** @inheritdoc */
  move(deltaX, deltaY) {
    __privateGet(this, _pos2)[0] += deltaX;
    __privateGet(this, _pos2)[1] += deltaY;
  }
  /** @inheritdoc */
  snapToGrid(snapTo) {
    if (!snapTo) return false;
  ...
  calculateAngle(lastRenderTime, network, linkStart) {
    ...
    const originToReroute = Math.atan2(
      __privateGet(this, _pos2)[1] - linkStart[1],
      __privateGet(this, _pos2)[0] - linkStart[0]
    );
    let diff = (originToReroute - sum) * 0.5;
    if (Math.abs(diff) > Math.PI * 0.5) diff += Math.PI;
    const dist = Math.min(_Reroute.maxSplineOffset, distance(linkStart, __privateGet(this, _pos2)) * 0.25);
   ...
   */
  drawSlots(ctx) {
    __privateGet(this, _inputSlot).draw(ctx);
    __privateGet(this, _outputSlot).draw(ctx);
  }
  ...
  updateVisibility(pos) {
    const input = __privateGet(this, _inputSlot);
    const output = __privateGet(this, _outputSlot);
    input.dirty = false;
    output.dirty = false;
    const { firstFloatingLink } = this;
    const hasLink = !!this.firstLink;
    const showInput = hasLink || (firstFloatingLink == null ? void 0 : firstFloatingLink.isFloatingOutput);
    const showOutput = hasLink || (firstFloatingLink == null ? void 0 : firstFloatingLink.isFloatingInput);
    const showEither = showInput || showOutput;
    if (showEither && isPointInRect(pos, __privateGet(this, _Reroute_instances, hoverArea_get))) {
      const outlineOnly = __privateMethod(this, _Reroute_instances, contains_fn).call(this, pos);
  ...
  hideSlots() {
    __privateGet(this, _inputSlot).hide();
    __privateGet(this, _outputSlot).hide();
  }
  /**
   ...
   */
  containsPoint(pos) {
    return isPointInRect(pos, __privateGet(this, _Reroute_instances, hoverArea_get)) && __privateMethod(this, _Reroute_instances, contains_fn).call(this, pos);
  }
  /** @inheritdoc */
  asSerialisable() {
...
_pos2 = new WeakMap();
_Reroute_instances = new WeakSet();
hoverArea_get = function() {
  const xOffset = 2 * _Reroute.slotOffset;
  const yOffset = 2 * Math.max(_Reroute.radius, _Reroute.slotRadius);
  const [x2, y] = __privateGet(this, _pos2);
  return [x2 - xOffset, y - yOffset, 2 * xOffset, 2 * yOffset];
};
_lastRenderTime = new WeakMap();
_inputSlot = new WeakMap();
_outputSlot = new WeakMap();
contains_fn = function(pos) {
  return distance(this.pos, pos) <= _Reroute.radius;
};
...
__publicField(_Reroute, "slotRadius", 5);
let Reroute = _Reroute;
class RerouteSlot {
  constructor(reroute, isInput) {
    /** The reroute that the slot belongs to. */
    __privateAdd(this, _reroute);
    __privateAdd(this, _offsetMultiplier);
    /** Whether any changes require a redraw. */
    __publicField(this, "dirty", false);
    __privateAdd(this, _hovering, false);
    __privateAdd(this, _showOutline, false);
    __privateSet(this, _reroute, reroute);
    __privateSet(this, _offsetMultiplier, isInput ? -1 : 1);
  }
  /** Centre point of this slot. */
  get pos() {
    const [x2, y] = __privateGet(this, _reroute).pos;
    return [x2 + Reroute.slotOffset * __privateGet(this, _offsetMultiplier), y];
  }
  /** Whether the pointer is hovering over the slot itself. */
  get hovering() {
    return __privateGet(this, _hovering);
  }
  set hovering(value) {
    if (!Object.is(__privateGet(this, _hovering), value)) {
      __privateSet(this, _hovering, value);
      this.dirty = true;
    }
  }
  /** Whether the slot outline / faint background is visible. */
  get showOutline() {
    return __privateGet(this, _showOutline);
  }
  set showOutline(value) {
    if (!Object.is(__privateGet(this, _showOutline), value)) {
      __privateSet(this, _showOutline, value);
      this.dirty = true;
    }
  }
  /**
  ...
  draw(ctx) {
    ...
    try {
      ctx.fillStyle = hovering ? __privateGet(this, _reroute).colour : "rgba(127,127,127,0.3)";
      ctx.strokeStyle = "rgb(0,0,0,0.5)";
      ctx.lineWidth = 1;
      ctx.beginPath();
...
_reroute = new WeakMap();
_offsetMultiplier = new WeakMap();
_hovering = new WeakMap();
_showOutline = new WeakMap();
...
const _ConstrainedSize = class _ConstrainedSize {
  constructor(width2, height) {
    __privateAdd(this, _width, 0);
    __privateAdd(this, _height, 0);
    __privateAdd(this, _desiredWidth, 0);
    __privateAdd(this, _desiredHeight, 0);
    __publicField(this, "minWidth", 0);
    __publicField(this, "minHeight", 0);
    __publicField(this, "maxWidth", Infinity);
    __publicField(this, "maxHeight", Infinity);
  ...
  get desiredWidth() {
    return __privateGet(this, _desiredWidth);
  }
  set desiredWidth(value) {
    __privateSet(this, _desiredWidth, value);
    __privateSet(this, _width, clamp(value, this.minWidth, this.maxWidth));
  }
  get desiredHeight() {
    return __privateGet(this, _desiredHeight);
  }
  set desiredHeight(value) {
    __privateSet(this, _desiredHeight, value);
    __privateSet(this, _height, clamp(value, this.minHeight, this.maxHeight));
  }
  static fromSize(size) {
    return new _ConstrainedSize(size[0], size[1]);
  }
  static fromRect(rect) {
    return new _ConstrainedSize(rect[2], rect[3]);
  }
  setSize(size) {
  ...
  toSize() {
    return [__privateGet(this, _width), __privateGet(this, _height)];
  }
};
_width = new WeakMap();
_height = new WeakMap();
_desiredWidth = new WeakMap();
_desiredHeight = new WeakMap();
let ConstrainedSize = _ConstrainedSize;
const _SubgraphSlot = class _SubgraphSlot extends SlotBase {
  constructor(slot, parent) {
    super(slot.name, slot.type);
    __privateAdd(this, _pos3, new Float32Array(2));
    __publicField(this, "measurement", new ConstrainedSize(_SubgraphSlot.defaultHeight, _SubgraphSlot.defaultHeight));
    __publicField(this, "id");
    __publicField(this, "parent");
    __publicField(this, "type");
    __publicField(this, "linkIds", []);
    __publicField(this, "boundingRect", new Rectangle(0, 0, 0, _SubgraphSlot.defaultHeight));
    __publicField(this, "isPointerOver", false);
  ...
  get pos() {
    return __privateGet(this, _pos3);
  }
  set pos(value) {
    if (!value || value.length < 2) return;
    __privateGet(this, _pos3)[0] = value[0];
    __privateGet(this, _pos3)[1] = value[1];
  }
  ...
  measure() {
    var _a;
    const width2 = ((_a = LGraphCanvas._measureText) == null ? void 0 : _a.call(LGraphCanvas, this.displayName)) ?? 0;
    const { defaultHeight } = _SubgraphSlot;
...
_pos3 = new WeakMap();
let SubgraphSlot = _SubgraphSlot;
class SubgraphOutput extends SubgraphSlot {
  connect(slot, node2, afterRerouteId) {
    ...
    if (((_a = node2.onConnectOutput) == null ? void 0 : _a.call(node2, outputIndex, this.type, this, this.parent, -1)) === false) return;
    ...
    if (existingLink != null) {
      ...
      const links = (_b = resolved.output) == null ? void 0 : _b.links;
    ...
    subgraph._version++;
    (_c = node2.onConnectionsChange) == null ? void 0 : _c.call(
      node2,
      NodeSlotType.OUTPUT,
      outputIndex,
      true,
...
const _SubgraphIONodeBase = class _SubgraphIONodeBase {
  constructor(subgraph) {
    __privateAdd(this, _SubgraphIONodeBase_instances);
    __privateAdd(this, _boundingRect, new Rectangle());
  ...
  showSlotContextMenu(slot, event) {
    const options = __privateMethod(this, _SubgraphIONodeBase_instances, getSlotMenuOptions_fn).call(this, slot);
    ...
    new LiteGraph.ContextMenu(
      options,
      {
        ...
        callback: (item) => {
          __privateMethod(this, _SubgraphIONodeBase_instances, onSlotMenuAction_fn).call(this, item, slot, event);
        }
      }
    );
  }
  ...
  arrange() {
    const { minWidth, roundedRadius } = _SubgraphIONodeBase;
  ...
  configure(data) {
    __privateGet(this, _boundingRect).set(data.bounding);
...
_SubgraphIONodeBase_instances = new WeakSet();
/**
 ...
 */
getSlotMenuOptions_fn = function(slot) {
  const options = [];
 ...
 * @param event The event that triggered the context menu.
 */
onSlotMenuAction_fn = function(selectedItem, slot, event) {
...
__publicField(_SubgraphIONodeBase, "margin", 10);
__publicField(_SubgraphIONodeBase, "minWidth", 100);
__publicField(_SubgraphIONodeBase, "roundedRadius", 10);
let SubgraphIONodeBase = _SubgraphIONodeBase;
class SubgraphOutputNode extends SubgraphIONodeBase {
  constructor() {
    super(...arguments);
    __publicField(this, "id", SUBGRAPH_OUTPUT_ID);
    __publicField(this, "emptySlot", new EmptySubgraphOutput(this));
  }
  get slots() {
  ...
  connectByTypeOutput(slot, target_node, target_slotType, optsIn) {
    ...
    return this.slots[slot].connect(outputSlot.slot, target_node, optsIn == null ? void 0 : optsIn.afterRerouteId);
  }
  findInputByType(type) {
    var _a;
    return (_a = findFreeSlotOfType(this.slots, type, (slot) => slot.linkIds.length > 0)) == null ? void 0 : _a.slot;
  }
...
class NodeInputSlot extends NodeSlot {
  ...
  get _widget() {
    var _a;
    return (_a = __privateGet(this, _widget)) == null ? void 0 : _a.deref();
  }
  set _widget(widget) {
    __privateSet(this, _widget, widget ? new WeakRef(widget) : void 0);
  }
  get collapsedPos() {
...
class NodeOutputSlot extends NodeSlot {
  constructor(slot, node2) {
    ...
    __privateSet(this, _node2, node2);
  }
  get isWidgetInputSlot() {
    return false;
  }
  get collapsedPos() {
    return [
      __privateGet(this, _node2)._collapsed_width ?? LiteGraph.NODE_COLLAPSED_WIDTH,
...
const _BaseWidget = class _BaseWidget {
  constructor(widget, node2) {
    ...
    __publicField(this, "computedDisabled");
    __publicField(this, "hidden");
    __publicField(this, "advanced");
    __publicField(this, "tooltip");
    __publicField(this, "element");
    __privateAdd(this, _value);
    __privateSet(this, _node3, node2 ?? widget.node);
  ...
  drawTruncatingText({
    ...
    const gap = _BaseWidget.labelValueGap;
  ...
  setValue(value, { e: e2, node: node2, canvas: canvas2 }) {
    ...
    (_c = node2.onWidgetChanged) == null ? void 0 : _c.call(node2, this.name ?? "", v2, oldValue, this);
...
__publicField(_BaseWidget, "margin", 15);
/** From widget edge to tip of arrow button */
__publicField(_BaseWidget, "arrowMargin", 6);
/** Arrow button width */
__publicField(_BaseWidget, "arrowWidth", 10);
/** Absolute minimum display width of widget values */
__publicField(_BaseWidget, "minValueWidth", 42);
/** Minimum gap between label and value */
__publicField(_BaseWidget, "labelValueGap", 5);
let BaseWidget = _BaseWidget;
class BooleanWidget extends BaseWidget {
  constructor() {
    super(...arguments);
    __publicField(this, "type", "toggle");
  }
  drawWidget(ctx, {
    width: width2,
    showText = true
...
class ComboWidget extends BaseSteppedWidget {
  constructor() {
    super(...arguments);
    __privateAdd(this, _ComboWidget_instances);
   ...
   */
  canIncrement() {
    return __privateMethod(this, _ComboWidget_instances, canUseButton_fn).call(this, true);
  }
  canDecrement() {
    return __privateMethod(this, _ComboWidget_instances, canUseButton_fn).call(this, false);
  }
  incrementValue(options) {
    __privateMethod(this, _ComboWidget_instances, tryChangeValue_fn).call(this, 1, options);
  }
  ...
  onClick({ e: e2, node: node2, canvas: canvas2 }) {
    ...
    const values = __privateMethod(this, _ComboWidget_instances, getValues_fn).call(this, node2);
...
_ComboWidget_instances = new WeakSet();
getValues_fn = function(node2) {
 ...
 */
canUseButton_fn = function(increment) {
  const { values } = this.options;
...
tryChangeValue_fn = function(delta2, options) {
  const values = __privateMethod(this, _ComboWidget_instances, getValues_fn).call(this, options.node);
...
class LegacyWidget extends BaseWidget {
  drawWidget(ctx, options) {
    ...
    (_a = this.draw) == null ? void 0 : _a.call(this, ctx, this.node, options.width, this.y, H, !!options.showText);
  }
  onClick() {
...
class SliderWidget extends BaseWidget {
  constructor() {
    super(...arguments);
    __publicField(this, "type", "slider");
...
class TextWidget extends BaseWidget {
  constructor(widget, node2) {
    ...
    this.value = ((_a = widget.value) == null ? void 0 : _a.toString()) ?? "";
  }
  /**
   * Draws the widget
   * @param ctx The canvas context
  ...
  onClick({ e: e2, node: node2, canvas: canvas2 }) {
    ...
    canvas2.prompt(
      ...
      e2,
      ((_a = this.options) == null ? void 0 : _a.multiline) ?? false
    );
  }
}
...
const _LGraphNode = class _LGraphNode {
  constructor(title, type) {
    ...
    __privateAdd(this, _concreteInputs, []);
    __privateAdd(this, _concreteOutputs, []);
    ...
    __publicField(this, "title_buttons", []);
    ...
    __privateAdd(this, _boundingRect2, new Rectangle());
    ...
    this.onMouseDown = (e2, pos, canvas2) => {
      var _a;
      if (((_a = this.title_buttons) == null ? void 0 : _a.length) && !this.flags.collapsed) {
   ...
   */
  get boundingRect() {
    return __privateGet(this, _boundingRect2);
  }
  ...
  configure(info) {
    ...
    for (const [i, input] of this.inputs.entries()) {
      ...
      (_d = this.onConnectionsChange) == null ? void 0 : _d.call(this, NodeSlotType.INPUT, i, true, link, input);
      (_e = this.onInputAdded) == null ? void 0 : _e.call(this, input);
    }
    ...
    for (const [i, output] of this.outputs.entries()) {
      ...
      for (const linkId of output.links) {
        ...
        (_f = this.onConnectionsChange) == null ? void 0 : _f.call(this, NodeSlotType.OUTPUT, i, true, link, output);
      }
      (_g = this.onOutputAdded) == null ? void 0 : _g.call(this, output);
    }
    (_h = this._internalConfigureAfterSlots) == null ? void 0 : _h.call(this);
    if (this.widgets) {
      for (const w of this.widgets) {
        if (!w) continue;
        if (((_i = w.options) == null ? void 0 : _i.property) && this.properties[w.options.property] != void 0)
    ...
    (_j = this.onConfigure) == null ? void 0 : _j.call(this, info);
  }
  /**
  ...
  doExecute(param, options) {
    ...
    options = options || {};
    if (this.onExecute) {
      options.action_call || (options.action_call = `${this.id}_exec_${Math.floor(Math.random() * 9999)}`);
      if (!this.graph) throw new NullGraphError();
      this.graph.nodes_executing[this.id] = true;
      this.onExecute(param, options);
      this.graph.nodes_executing[this.id] = false;
      this.exec_version = this.graph.iteration;
      if (options == null ? void 0 : options.action_call) {
        this.action_call = options.action_call;
        this.graph.nodes_executedAction[this.id] = options.action_call;
      }
    }
    this.execute_triggered = 2;
    (_a = this.onAfterExecuteNode) == null ? void 0 : _a.call(this, param, options);
  }
  /**
  ...
  actionDo(action, param, options) {
    ...
    options = options || {};
    if (this.onAction) {
      options.action_call || (options.action_call = `${this.id}_${action || "action"}_${Math.floor(Math.random() * 9999)}`);
      if (!this.graph) throw new NullGraphError();
  ...
  triggerSlot(slot, param, link_id, options) {
    ...
    for (const id of links) {
      ...
      if (node2.mode === LGraphEventMode.ON_TRIGGER) {
        ...
        (_a = node2.doExecute) == null ? void 0 : _a.call(node2, param, options);
  ...
  computeSize(out) {
    ...
    const minWidth = LiteGraph.NODE_WIDTH * ((widgets == null ? void 0 : widgets.length) ? 1.5 : 1);
    ...
    function compute_text_size(text, fontStyle) {
      var _a;
      return ((_a = LGraphCanvas._measureText) == null ? void 0 : _a.call(LGraphCanvas, text, fontStyle)) ?? font_size * ((text == null ? void 0 : text.length) ?? 0) * 0.6;
    }
  ...
  findResizeDirection(canvasX, canvasY) {
    ...
    return boundingRect.findContainingCorner(canvasX, canvasY, _LGraphNode.resizeHandleSize);
  }
  /**
  ...
  addTitleButton(options) {
    this.title_buttons || (this.title_buttons = []);
  ...
  removeWidgetByName(name) {
    var _a;
    const widget = (_a = this.widgets) == null ? void 0 : _a.find((x2) => x2.name === name);
  ...
  updateArea(ctx) {
    var _a;
    const bounds = __privateGet(this, _boundingRect2);
  ...
  getWidgetOnPos(canvasX, canvasY, includeDisabled = false) {
    ...
    if (!(widgets == null ? void 0 : widgets.length)) return;
    ...
    for (const widget of widgets) {
      ...
      const h = widget.computedHeight ?? ((_a = widget.computeSize) == null ? void 0 : _a.call(widget, nodeWidth)[1]) ?? LiteGraph.NODE_WIDGET_HEIGHT;
  ...
  findOutputByType(type) {
    return findFreeSlotOfType(this.outputs, type, (output) => {
      var _a;
      return !((_a = output.links) == null ? void 0 : _a.length);
    });
  }
  /**
  ...
  connectSlots(output, inputNode, input, afterRerouteId) {
    ...
    graph._version++;
    (_d = this.onConnectionsChange) == null ? void 0 : _d.call(
      this,
      NodeSlotType.OUTPUT,
      outputIndex,
      true,
    ...
    (_e = inputNode.onConnectionsChange) == null ? void 0 : _e.call(
      inputNode,
      NodeSlotType.INPUT,
      inputIndex,
      true,
  ...
  disconnectInput(slot, keepReroutes) {
    ...
    if (link_id != null) {
      ...
      if (link_info) {
        ...
        if (!((_b = output == null ? void 0 : output.links) == null ? void 0 : _b.length)) {
  ...
  getConnectionPos(is_input, slot_number, out) {
    ...
    const slotIndex = is_input ? __privateGet(this, _LGraphNode_instances, defaultVerticalInputs_get).indexOf(this.inputs[slot_number]) : __privateGet(this, _LGraphNode_instances, defaultVerticalOutputs_get).indexOf(this.outputs[slot_number]);
  ...
  getInputSlotPos(input) {
    ...
    const slotIndex = __privateGet(this, _LGraphNode_instances, defaultVerticalInputs_get).indexOf(input);
  ...
  getOutputPos(slot) {
    ...
    const offsetX = LiteGraph.NODE_SLOT_HEIGHT * 0.5;
    const nodeOffsetY = this.constructor.slot_start_y || 0;
    const slotIndex = __privateGet(this, _LGraphNode_instances, defaultVerticalOutputs_get).indexOf(this.outputs[slot]);
    const slotY = (slotIndex + 0.7) * LiteGraph.NODE_SLOT_HEIGHT;
  ...
  drawTitleText(ctx, {
    ...
    if (title) {
      ...
      if (((_a = this.title_buttons) == null ? void 0 : _a.length) > 0) {
        let buttonsWidth = 0;
  ...
  connectInputToOutput() {
    ...
    if (!(this.flags.keepAllLinksOnBypass ?? _LGraphNode.keepAllLinksOnBypass))
    ...
    function bypassAllLinks(output, inNode, inLink, graph2) {
      var _a;
      const outLinks = (_a = output.links) == null ? void 0 : _a.map((x2) => _links.get(x2)).filter((x2) => !!x2);
  ...
  drawWidgets(ctx, {
    ...
    for (const widget of widgets) {
      ...
      widget.last_y = y;
      widget.computedDisabled = widget.disabled || ((_a = this.getSlotFromWidget(widget)) == null ? void 0 : _a.link) != null;
      ...
      if (typeof widget.draw === "function") {
        ...
        (_b = toConcreteWidget(widget, this, false)) == null ? void 0 : _b.drawWidget(ctx, { width: width2, showText });
      }
      ctx.globalAlpha = editorAlpha;
    }
    ctx.restore();
  ...
  drawCollapsedSlots(ctx) {
    var _a;
    for (const slot of __privateGet(this, _concreteInputs)) {
      if (slot.link != null) {
        slot.drawCollapsed(ctx);
        break;
      }
    }
    for (const slot of __privateGet(this, _concreteOutputs)) {
      if ((_a = slot.links) == null ? void 0 : _a.length) {
        slot.drawCollapsed(ctx);
        break;
      }
    }
  ...
  getWidgetFromSlot(slot) {
    ...
    return (_a = this.widgets) == null ? void 0 : _a.find((w) => w.name === slot.widget.name);
  }
  /**
  ...
  drawSlots(ctx, {
    ...
    for (const slot of [...__privateGet(this, _concreteInputs), ...__privateGet(this, _concreteOutputs)]) {
      const isValidTarget = fromSlot && slot.isValidTarget(fromSlot);
      const isMouseOverSlot = __privateMethod(this, _LGraphNode_instances, isMouseOverSlot_fn).call(this, slot);
      const isValid = !fromSlot || isValidTarget;
      const highlight = isValid && isMouseOverSlot;
      if (isMouseOverSlot || isValidTarget || !slot.isWidgetInputSlot || __privateMethod(this, _LGraphNode_instances, isMouseOverWidget_fn).call(this, this.getWidgetFromSlot(slot)) || slot.isConnected) {
        ctx.globalAlpha = isValid ? editorAlpha : 0.4 * editorAlpha;
        slot.draw(ctx, {
          colorContext,
          lowQuality,
   ...
   */
  _setConcreteSlots() {
    __privateSet(this, _concreteInputs, this.inputs.map((slot) => toClass(NodeInputSlot, slot, this)));
    __privateSet(this, _concreteOutputs, this.outputs.map((slot) => toClass(NodeOutputSlot, slot, this)));
  }
  /**
   * Arranges node elements in preparation for rendering (slots & widgets).
   */
  arrange() {
    const slotsBounds = __privateMethod(this, _LGraphNode_instances, measureSlots_fn).call(this);
    const widgetStartY = slotsBounds ? slotsBounds[1] + slotsBounds[3] - this.pos[1] : 0;
    __privateMethod(this, _LGraphNode_instances, arrangeWidgets_fn).call(this, widgetStartY);
    __privateMethod(this, _LGraphNode_instances, arrangeWidgetInputSlots_fn).call(this);
  }
  /**
...
_concreteInputs = new WeakMap();
_concreteOutputs = new WeakMap();
_renderArea = new WeakMap();
_boundingRect2 = new WeakMap();
 ...
 */
findFreeSlot_fn = function(slots, options) {
  var _a, _b, _c;
  const defaults = {
    returnObj: false,
    typesNotAccepted: []
      ...
      for (const destType of destTypes) {
        ...
        if (source == dest || source === "*" || dest === "*") {
          if (preferFreeSlot && (((_a = slot.links) == null ? void 0 : _a.length) || slot.link != null)) {
            occupiedSlot ?? (occupiedSlot = returnObj ? slot : i);
            continue;
          }
...
defaultVerticalInputs_get = function() {
  return this.inputs.filter(
    (slot) => {
      var _a;
      return !slot.pos && !(((_a = this.widgets) == null ? void 0 : _a.length) && isWidgetInputSlot(slot));
    }
  );
};
defaultVerticalOutputs_get = function() {
  return this.outputs.filter((slot) => !slot.pos);
};
measureSlot_fn = function(slot, slotIndex, isInput) {
...
measureSlots_fn = function() {
  var _a;
  const slots = [];
  for (const [slotIndex, slot] of __privateGet(this, _concreteInputs).entries()) {
    if (((_a = this.widgets) == null ? void 0 : _a.length) && isWidgetInputSlot(slot)) continue;
    __privateMethod(this, _LGraphNode_instances, measureSlot_fn).call(this, slot, slotIndex, true);
    slots.push(slot);
  }
  for (const [slotIndex, slot] of __privateGet(this, _concreteOutputs).entries()) {
    __privateMethod(this, _LGraphNode_instances, measureSlot_fn).call(this, slot, slotIndex, false);
    slots.push(slot);
  }
...
getMouseOverSlot_fn = function(slot) {
  ...
  const mouseOverId = ((_a = this.mouseOver) == null ? void 0 : _a[isInput ? "inputId" : "outputId"]) ?? -1;
  if (mouseOverId === -1) {
    return null;
  }
...
isMouseOverWidget_fn = function(widget) {
  var _a;
  if (!widget) return false;
  return ((_a = this.mouseOver) == null ? void 0 : _a.overWidget) === widget;
};
/**
 ...
 */
arrangeWidgets_fn = function(widgetStartY) {
 ...
 */
arrangeWidgetInputSlots_fn = function() {
  if (!this.widgets) return;
  ...
  for (const widget of this.widgets) {
    ...
    if (!slot) continue;
    const actualSlot = __privateGet(this, _concreteInputs)[slot.index];
    const offset = LiteGraph.NODE_SLOT_HEIGHT * 0.5;
    actualSlot.pos = [offset, widget.y + offset];
    __privateMethod(this, _LGraphNode_instances, measureSlot_fn).call(this, actualSlot, slot.index, true);
  }
};
...
__publicField(_LGraphNode, "resizeHandleSize", 15);
__publicField(_LGraphNode, "resizeEdgeSize", 5);
    ...
    for (const validType of validTypes) {
      for (const slotType of slotTypes) {
        if (slotType === validType) {
          ...
          occupiedSlot ?? (occupiedSlot = { index, slot });
        } else if (!wildSlot && (validType === "*" || slotType === "*")) {
          if (hasNoLinks(slot)) {
            wildSlot = { index, slot };
          } else {
            occupiedWildSlot ?? (occupiedWildSlot = { index, slot });
          }
        }
      }
    }
...
class SubgraphInput extends SubgraphSlot {
  constructor() {
    super(...arguments);
    __publicField(this, "events", new CustomEventTarget());
    /** The linked widget that this slot is connected to. */
    __privateAdd(this, _widgetRef);
  }
  get _widget() {
    var _a;
    return (_a = __privateGet(this, _widgetRef)) == null ? void 0 : _a.deref();
  }
  set _widget(widget) {
    __privateSet(this, _widgetRef, widget ? new WeakRef(widget) : void 0);
  }
  connect(slot, node2, afterRerouteId) {
    var _a, _b;
    const { subgraph } = this.parent;
    const inputIndex = node2.inputs.indexOf(slot);
    if (((_a = node2.onConnectInput) == null ? void 0 : _a.call(node2, inputIndex, this.type, this, this.parent, -1)) === false) return;
    if (slot.link != null) {
      subgraph.beforeChange();
    ...
    if (inputWidget) {
      ...
      this._widget ?? (this._widget = inputWidget);
    ...
    subgraph._version++;
    (_b = node2.onConnectionsChange) == null ? void 0 : _b.call(
      node2,
      NodeSlotType.INPUT,
      inputIndex,
      true,
  ...
  getConnectedWidgets() {
    ...
    for (const linkId of this.linkIds) {
      ...
      if (resolved.input && ((_a = resolved.inputNode) == null ? void 0 : _a.widgets)) {
  ...
  matchesWidget(otherWidget) {
    var _a;
    const widget = (_a = __privateGet(this, _widgetRef)) == null ? void 0 : _a.deref();
...
class SubgraphInputNode extends SubgraphIONodeBase {
  constructor() {
    super(...arguments);
    __publicField(this, "id", SUBGRAPH_INPUT_ID);
    __publicField(this, "emptySlot", new EmptySubgraphInput(this));
  }
  get slots() {
  ...
  connectByType(slot, target_node, target_slotType, optsIn) {
    ...
    return this.slots[slot].connect(inputSlot.slot, target_node, optsIn == null ? void 0 : optsIn.afterRerouteId);
  }
  findOutputSlot(name) {
...
class FloatingRenderLink {
  constructor(network, link, toType, fromReroute, dragDirection = LinkDirection.CENTER) {
    ...
    if (outputNodeId !== -1) {
      ...
      this.fromPos = (fromReroute == null ? void 0 : fromReroute.pos) ?? this.outputPos;
  ...
  connectToInput(node2, input, _events) {
    ...
    input._floatingLinks ?? (input._floatingLinks = /* @__PURE__ */ new Set());
...
class MovingInputLink extends MovingLinkBase {
  ...
  connectToSubgraphOutput(output, events) {
    var _a;
    const newLink = output.connect(this.fromSlot, this.node, (_a = this.fromReroute) == null ? void 0 : _a.id);
    events == null ? void 0 : events.dispatch("link-created", newLink);
  }
...
class MovingOutputLink extends MovingLinkBase {
  constructor(network, link, fromReroute, dragDirection = LinkDirection.CENTER) {
    ...
    this.fromPos = (fromReroute == null ? void 0 : fromReroute.pos) ?? this.inputPos;
    this.fromDirection = LinkDirection.LEFT;
  ...
  connectToSubgraphInput(input, events) {
    var _a;
    const newLink = input.connect(this.fromSlot, this.node, (_a = this.fromReroute) == null ? void 0 : _a.id);
    events == null ? void 0 : events.dispatch("link-created", newLink);
  }
...
class ToInputFromIoNodeLink {
  constructor(network, node2, fromSlot, fromReroute, dragDirection = LinkDirection.CENTER, existingLink) {
    ...
    __publicField(this, "existingLink");
    this.network = network;
    this.node = node2;
  ...
  connectToInput(node2, input, events) {
    ...
    const newLink = fromSlot.connect(input, node2, fromReroute == null ? void 0 : fromReroute.id);
    if (existingLink) {
      events.dispatch("input-moved", this);
    } else {
...
class ToOutputFromIoNodeLink {
  ...
  connectToOutput(node2, output, events) {
    const { fromSlot, fromReroute } = this;
    const newLink = fromSlot.connect(output, node2, fromReroute == null ? void 0 : fromReroute.id);
    events.dispatch("link-created", newLink);
  }
  connectToSubgraphInput() {
    throw new Error("Not implemented");
  ...
  connectToRerouteOutput(reroute, outputNode, output, events) {
    const { fromSlot } = this;
    const newLink = fromSlot.connect(output, outputNode, reroute == null ? void 0 : reroute.id);
    events.dispatch("link-created", newLink);
  }
  connectToInput() {
...
class LinkConnector {
  ...
  moveInputLink(network, input) {
    ...
    if (linkId == null) {
      ...
      if (link.origin_id === SUBGRAPH_INPUT_ID) {
        const subgraphInput = (_b = network.inputNode) == null ? void 0 : _b.slots[link.origin_slot];
        if (!subgraphInput) {
  ...
  dropLinks(locator, event) {
    ...
    try {
      ...
      const ioNode = (_a = locator.getIoNodeOnPos) == null ? void 0 : _a.call(locator, canvasX, canvasY);
      if (ioNode) {
  ...
  dropOnNode(node2, event) {
    ...
    if (connectingTo === "output") {
      ...
      if (inputOrSocket) {
        __privateMethod(this, _LinkConnector_instances, dropOnInput_fn).call(this, node2, inputOrSocket);
      } else {
        this.connectToNode(node2, event);
      }
    }
...
const _CanvasPointer = class _CanvasPointer {
  constructor(element) {
  ...
  move(e2) {
    ...
    if (longerThanBufferTime || !__privateMethod(this, _CanvasPointer_instances, hasSamePosition_fn).call(this, e2, eDown)) {
      __privateMethod(this, _CanvasPointer_instances, setDragStarted_fn).call(this, e2);
    }
  }
  /**
...
setDragStarted_fn = function(eMove) {
  var _a;
  this.dragStarted = true;
  (_a = this.onDragStart) == null ? void 0 : _a.call(this, this, eMove);
  delete this.onDragStart;
};
...
let CanvasPointer = _CanvasPointer;
class DragAndScale {
  constructor(element) {
    __privateAdd(this, _DragAndScale_instances);
    /**
  ...
  computeVisibleArea(viewport) {
    ...
    if (__privateMethod(this, _DragAndScale_instances, stateHasChanged_fn).call(this)) {
      (_a = this.onChanged) == null ? void 0 : _a.call(this, scale, offset);
...
_DragAndScale_instances = new WeakSet();
/**
...
const _LGraphCanvas = class _LGraphCanvas {
  ...
  constructor(canvas2, graph, options) {
    ...
    __publicField(this, "colourGetter", {
    ...
    __privateAdd(this, _visibleReroutes, /* @__PURE__ */ new Set());
    ...
    this.linkConnector.events.addEventListener("link-created", () => __privateMethod(this, _LGraphCanvas_instances, dirty_fn).call(this));
    ...
    this.clear();
    _LGraphCanvas._measureText = (text, fontStyle = this.inner_text_font) => {
      const { ctx } = this;
      const { font } = ctx;
      try {
        ctx.font = fontStyle;
  ...
  get subgraph() {
    return __privateGet(this, _subgraph);
  }
  set subgraph(value) {
    if (value !== __privateGet(this, _subgraph)) {
      __privateSet(this, _subgraph, value);
      if (value) this.dispatch("litegraph:set-graph", { oldGraph: __privateGet(this, _subgraph), newGraph: value });
    }
  }
  dispatch(type, detail) {
  ...
  getWidgetAtCursor(node2) {
    node2 ?? (node2 = this.node_over);
    return node2 == null ? void 0 : node2.getWidgetOnPos(this.graph_mouse[0], this.graph_mouse[1], true);
  }
  /**
  ...
  processMouseDown(e2) {
    ...
    if (((_a = this.onMouse) == null ? void 0 : _a.call(this, e2)) == true) return;
    if (e2.button === 0 && !pointer.isDouble) {
      ...
      if (subgraph == null ? void 0 : subgraph.inputNode.containsPoint(this.graph_mouse)) {
        this.processSelect(subgraph.inputNode, e2, true);
        subgraph.inputNode.onPointerDown(e2, pointer, linkConnector);
      } else if (subgraph == null ? void 0 : subgraph.outputNode.containsPoint(this.graph_mouse)) {
        ...
        if (node2) {
          ...
          const reroute = graph.getRerouteOnPos(e2.canvasX, e2.canvasY, __privateGet(this, _visibleReroutes));
          if (reroute) {
            if (e2.altKey) {
        ...
        pointer.onClick ?? (pointer.onClick = () => this.processContextMenu(node2, e2));
      }
    }
    ...
    e2.stopPropagation();
    (_b = this.onMouseDown) == null ? void 0 : _b.call(this, e2);
  }
  /**
    ...
    if (dragRect) {
      ...
      if (node2) {
        ...
        if (!node2.mouseOver) {
          ...
          this.dirty_canvas = true;
          for (const reroute of __privateGet(this, _visibleReroutes)) {
            reroute.hideSlots();
            this.dirty_bgcanvas = true;
          }
          (_a = node2.onMouseEnter) == null ? void 0 : _a.call(node2, e2);
        }
        (_b = node2.onMouseMove) == null ? void 0 : _b.call(node2, e2, [x2 - node2.pos[0], y - node2.pos[1]], this);
        ...
        if (!pointer.eDown) {
          if (inputId === -1 && outputId === -1 && !overWidget) {
            ...
            pointer.resizeDirection && (pointer.resizeDirection = void 0);
          }
        }
      } else {
        underPointer = __privateMethod(this, _LGraphCanvas_instances, updateReroutes_fn).call(this, underPointer);
      ...
      if (this.node_capturing_input && this.node_capturing_input != node2) {
        (_d = (_c = this.node_capturing_input).onMouseMove) == null ? void 0 : _d.call(
          _c,
          e2,
          [
  ...
  processKey(e2) {
    ...
    if (e2.type == "keydown") {
      if (e2.key === " ") {
        ...
        if (e2.target.localName != "input" && e2.target.localName != "textarea") {
          if (this.selectedItems.size === 0) {
            __privateMethod(this, _LGraphCanvas_instances, noItemsSelected_fn).call(this);
            return;
          }
          this.deleteSelected();
          block_default = true;
      ...
      for (const node2 of Object.values(this.selected_nodes)) {
        (_c = node2.onKeyDown) == null ? void 0 : _c.call(node2, e2);
      }
      ...
      for (const node2 of Object.values(this.selected_nodes)) {
        (_d = node2.onKeyUp) == null ? void 0 : _d.call(node2, e2);
      }
    }
    graph.change();
    if (block_default) {
  ...
  _pasteFromClipboard(options = {}) {
    ...
    parsed.reroutes ?? (parsed.reroutes = []);
    parsed.links ?? (parsed.links = []);
    parsed.subgraphs ?? (parsed.subgraphs = []);
    ...
    for (const info of parsed.links) {
      ...
      let afterRerouteId;
      if (info.parentId != null) afterRerouteId = (_a = reroutes.get(info.parentId)) == null ? void 0 : _a.id;
      if (connectInputs && LiteGraph.ctrl_shift_v_paste_connect_unselected_outputs) {
        outNode ?? (outNode = graph.getNodeById(info.origin_id));
        afterRerouteId ?? (afterRerouteId = info.parentId);
      }
    ...
    for (const reroute of reroutes.values()) {
      const ids = [...reroute.linkIds].map((x2) => {
        var _a2;
        return ((_a2 = links.get(x2)) == null ? void 0 : _a2.id) ?? x2;
      });
  ...
  drawFrontCanvas() {
    ...
    if (graph) {
      ...
      (_d = this.subgraph) == null ? void 0 : _d.draw(ctx, this.colourGetter, (_c = this.linkConnector.renderLinks[0]) == null ? void 0 : _c.fromSlot, this.editor_alpha);
      ...
      if (!this.isDragging && this.over_link_center && this.render_link_tooltip) {
        ...
        (_e = this.onDrawLinkTooltip) == null ? void 0 : _e.call(this, ctx, null);
      }
      (_f = this.onDrawForeground) == null ? void 0 : _f.call(this, ctx, this.visible_area);
      ctx.restore();
    }
    (_g = this.onDrawOverlay) == null ? void 0 : _g.call(this, ctx);
    if (area) ctx.restore();
  }
  /**
  ...
  drawBackCanvas() {
    ...
    if (this.graph) {
      ...
      (_a = this.onDrawBackground) == null ? void 0 : _a.call(this, ctx, this.visible_area);
  ...
  drawConnections(ctx) {
    ...
    if (subgraph) {
      for (const output of subgraph.inputNode.slots) {
        ...
        for (const linkId of output.linkIds) {
          ...
          __privateMethod(this, _LGraphCanvas_instances, renderAllLinkSegments_fn).call(this, ctx, link, output.pos, endPos, visibleReroutes, now, input.dir, input.dir);
        }
      }
      for (const input of subgraph.outputNode.slots) {
        ...
        __privateMethod(this, _LGraphCanvas_instances, renderAllLinkSegments_fn).call(this, ctx, link, startPos, input.pos, visibleReroutes, now, output.dir, input.dir);
      }
    }
    ...
    const rerouteSet = __privateGet(this, _visibleReroutes);
    rerouteSet.clear();
  ...
  renderLink(ctx, a, b, link, skip_border, flow, color, start_dir, end_dir, {
    ...
    const pos = (linkSegment == null ? void 0 : linkSegment._pos) ?? [0, 0];
      ...
      switch (v2) {
        case "Add Node":
          _LGraphCanvas.onMenuAdd(null, null, e22, menu, (node2) => {
            ...
            if (node_left == null ? void 0 : node_left.connectByType(origin_slot, node2, fromType ?? "*", options3)) {
  ...
  showConnectionMenu(optPass) {
    ...
    function inner_clicked(v2, options2, e2) {
      ...
      switch (v2) {
        ...
        default: {
          const customProps = {
            position: [((_a = opts.e) == null ? void 0 : _a.canvasX) ?? 0, ((_b = opts.e) == null ? void 0 : _b.canvasY) ?? 0],
            nodeType: v2,
            afterRerouteId
          };
  ...
  showEditPropertyValue(node2, property, options) {
    ...
    function setValue(value) {
      ...
      (_b = options.onclose) == null ? void 0 : _b.call(options);
      dialog.close();
      dirty();
    }
    return dialog;
  ...
  createPanel(title, options) {
    ...
    root.addWidget = function(type, name, value, options2, callback) {
      ...
      if (type == "code") {
        ...
        const str_value2 = _LGraphCanvas.getPropertyPrintableValue(value, options2.values);
        if (!value_element) throw new TypeError("Property name element was null.");
      ...
      function innerChange(name2, value2) {
        var _a;
        (_a = options2.callback) == null ? void 0 : _a.call(options2, name2, value2, options2);
        callback == null ? void 0 : callback(name2, value2, options2);
      }
      return elem;
    };
  ...
  getCanvasMenuOptions() {
    ...
    const extra = (_a = this.getExtraMenuOptions) == null ? void 0 : _a.call(this, this, options);
  ...
  getNodeMenuOptions(node2) {
    ...
    const extra = (_b = node2.getExtraMenuOptions) == null ? void 0 : _b.call(node2, this, options);
    ...
    (_d = (_c = node2.graph) == null ? void 0 : _c.onGetNodeMenuOptions) == null ? void 0 : _d.call(_c, options, node2);
    return options;
  }
  /** @deprecated */
    ...
    if (node2) {
      ...
      if (slot) {
        ...
        if (node2.getSlotMenuOptions) {
          ...
          if (((_b = (_a = slot.output) == null ? void 0 : _a.links) == null ? void 0 : _b.length) || ((_c = slot.input) == null ? void 0 : _c.link) != null) {
      ...
      if (this.links_render_mode !== LinkRenderType.HIDDEN_LINK) {
        const reroute = this.graph.getRerouteOnPos(event.canvasX, event.canvasY, __privateGet(this, _visibleReroutes));
        if (reroute) {
          menu_info.unshift({
 ...
 */
getPositionableOnPos_fn = function(x2, y) {
  var _a, _b;
  const ioNode = (_a = this.subgraph) == null ? void 0 : _a.getIoNodeOnPos(x2, y);
  if (ioNode) return ioNode;
  for (const reroute of __privateGet(this, _visibleReroutes)) {
    if (reroute.containsPoint([x2, y])) return reroute;
  }
  return (_b = this.graph) == null ? void 0 : _b.getGroupTitlebarOnPos(x2, y);
};
processPrimaryButton_fn = function(e2, node2) {
  ...
  if (ctrlOrMeta && !e2.altKey && LiteGraph.canvasNavigationMode === "legacy") {
    __privateMethod(this, _LGraphCanvas_instances, setupNodeSelectionDrag_fn).call(this, e2, pointer, node2);
    return;
  }
  if (this.read_only) {
  ...
  if (node2 && (this.allow_interaction || node2.flags.allow_interaction)) {
    ...
    if (subgraph) {
      let processSubgraphIONode = function(canvas2, ioNode) {
        ...
        pointer.onClick ?? (pointer.onClick = () => canvas2.processSelect(ioNode, e2));
        pointer.onDragStart ?? (pointer.onDragStart = () => {
          var _a2;
          return __privateMethod(_a2 = canvas2, _LGraphCanvas_instances, startDraggingItems_fn).call(_a2, ioNode, pointer, true);
        });
        pointer.onDragEnd ?? (pointer.onDragEnd = (eUp) => {
          var _a2;
          return __privateMethod(_a2 = canvas2, _LGraphCanvas_instances, processDraggedItems_fn).call(_a2, eUp);
        });
        return true;
      };
    ...
    if (this.links_render_mode !== LinkRenderType.HIDDEN_LINK) {
      for (const reroute of __privateGet(this, _visibleReroutes)) {
        ...
        if (reroute.isOutputHovered || overReroute && e2.shiftKey) {
          ...
          __privateMethod(this, _LGraphCanvas_instances, linkConnectorDrop_fn).call(this);
        }
  ...
  if (!pointer.onDragStart && !pointer.onClick && !pointer.onDrag && this.allow_dragcanvas) {
    if (LiteGraph.canvasNavigationMode !== "standard" || this.read_only) {
      ...
      __privateMethod(this, _LGraphCanvas_instances, setupNodeSelectionDrag_fn).call(this, e2, pointer);
    }
  }
};
setupNodeSelectionDrag_fn = function(e2, pointer, node2) {
  ...
  dragRect[3] = 1;
  pointer.onClick = (eUp) => {
    const clickedItem = node2 ?? __privateMethod(this, _LGraphCanvas_instances, getPositionableOnPos_fn).call(this, eUp.canvasX, eUp.canvasY);
...
processNodeClick_fn = function(e2, ctrlOrMeta, node2) {
  ...
  if (widget) {
    ...
    if ((_d = node2.onMouseDown) == null ? void 0 : _d.call(node2, e2, pos, this)) {
      pointer.onClick = () => {
      };
      return;
    }
      ...
      if (resizeDirection) {
        ...
        pointer.onDrag = (eMove) => {
          ...
          if (__privateGet(this, _snapToGrid)) {
            ...
            snapPoint(newBounds.size, __privateGet(this, _snapToGrid));
          }
 ...
 */
updateReroutes_fn = function(underPointer) {
  const { graph, pointer, linkConnector } = this;
  if (!graph) throw new NullGraphError();
  if (!pointer.isDown) {
    let anyChanges = false;
    for (const reroute of __privateGet(this, _visibleReroutes)) {
      anyChanges || (anyChanges = reroute.updateVisibility(this.graph_mouse));
...
renderSnapHighlight_fn = function(ctx, highlightPos) {
  ...
  overReroute == null ? void 0 : overReroute.drawHighlight(ctx, "#ffcc00aa");
  ...
  if (reroutes.length) {
    ...
    for (let j = 0; j < l; j++) {
      ...
      if (!renderedPaths.has(reroute)) {
        ...
        const rerouteStartPos = (prevReroute == null ? void 0 : prevReroute.pos) ?? startPos;
      ...
      if (!startControl && ((_b = (_a = reroutes.at(-1)) == null ? void 0 : _a.floating) == null ? void 0 : _b.slotType) === "input") {
        startControl = [0, 0];
      } else {
        const nextPos = ((_c = reroutes[j + 1]) == null ? void 0 : _c.pos) ?? endPos;
 ...
 */
__publicField(_LGraphCanvas, "_measureText");
...
const _LGraph = class _LGraph {
   ...
   */
  constructor(o) {
    __privateAdd(this, _LGraph_instances);
    ...
    __publicField(this, "events", new CustomEventTarget());
    __publicField(this, "_subgraphs", /* @__PURE__ */ new Map());
    __publicField(this, "_nodes", []);
  ...
  *positionableItems() {
  ...
  clear() {
    ...
    if (this._nodes) {
      for (const _node4 of this._nodes) {
        (_a = _node4.onRemoved) == null ? void 0 : _a.call(_node4);
      }
    }
    this._nodes = [];
    this._nodes_by_id = {};
  ...
  attachCanvas(canvas2) {
    ...
    (_a = canvas2.graph) == null ? void 0 : _a.detachCanvas(canvas2);
    canvas2.graph = this;
  ...
  addFloatingLink(link) {
    ...
    if (slot) {
      slot._floatingLinks ?? (slot._floatingLinks = /* @__PURE__ */ new Set());
  ...
  setReroute({ id, parentId, pos, linkIds, floating }) {
    id ?? (id = ++this.state.lastRerouteId);
  ...
  convertToSubgraph(items) {
    ...
    for (const resolved of resolvedInputLinks) (_a = resolved.inputNode) == null ? void 0 : _a.disconnectInput(resolved.inputNode.inputs.indexOf(resolved.input), true);
    for (const resolved of resolvedOutputLinks) (_b = resolved.outputNode) == null ? void 0 : _b.disconnectOutput(resolved.outputNode.outputs.indexOf(resolved.output), resolved.inputNode);
  ...
  asSerialisable(options) {
    ...
    const nodeList = !LiteGraph.use_uuids && (options == null ? void 0 : options.sortNodes) ? [...this._nodes].sort((a, b) => a.id - b.id) : this._nodes;
    ...
    if (LiteGraph.saveViewportWithGraph) extra.ds = __privateMethod(this, _LGraph_instances, getDragAndScale_fn).call(this);
  ...
  configure(data, keep_old) {
    ...
    try {
      ...
      for (const i in data) {
        if (_LGraph.ConfigureProperties.has(i)) continue;
        this[i] = data[i];
      }
      const subgraphs = (_a = data.definitions) == null ? void 0 : _a.subgraphs;
      if (subgraphs) {
        for (const subgraph of subgraphs) this.createSubgraph(subgraph);
        for (const subgraph of subgraphs) (_b = this.subgraphs.get(subgraph.id)) == null ? void 0 : _b.configure(subgraph);
      }
      let error = false;
      ...
      if (nodesData) {
        ...
        for (const [id, nodeData] of nodeDataMap) {
          (_c = this.getNodeById(id)) == null ? void 0 : _c.configure(nodeData);
        }
      }
      ...
      this.updateExecutionOrder();
      (_d = this.onConfigure) == null ? void 0 : _d.call(this, data);
      this._version++;
      const { primaryCanvas } = this;
      const subgraphId = (_e = primaryCanvas == null ? void 0 : primaryCanvas.subgraph) == null ? void 0 : _e.id;
      if (subgraphId) {
  ...
  get primaryCanvas() {
    return __privateGet(this.rootGraph, _canvas);
  }
  set primaryCanvas(canvas2) {
    __privateSet(this.rootGraph, _canvas, canvas2);
  }
  load(url, callback) {
    const that = this;
...
_LGraph_instances = new WeakSet();
/** @returns The drag and scale state of the first attached canvas, otherwise `undefined`. */
getDragAndScale_fn = function() {
  var _a, _b;
  const ds = (_b = (_a = this.list_of_graphcanvas) == null ? void 0 : _a.at(0)) == null ? void 0 : _b.ds;
...
__publicField(_LGraph, "ConfigureProperties", /* @__PURE__ */ new Set([
  "nodes",
  "groups",
  "links",
  "state",
...
let LGraph = _LGraph;
const _Subgraph = class _Subgraph extends LGraph {
  constructor(rootGraph, data) {
    if (!rootGraph) throw new Error("Root graph is required");
    super();
    __privateAdd(this, _Subgraph_instances);
    /** The display name of the subgraph. */
    __publicField(this, "name", "Unnamed Subgraph");
    __publicField(this, "inputNode", new SubgraphInputNode(this));
    __publicField(this, "outputNode", new SubgraphOutputNode(this));
    ...
    __publicField(this, "widgets", []);
    __privateAdd(this, _rootGraph);
    __privateSet(this, _rootGraph, rootGraph);
    const cloned = structuredClone(data);
    this._configureBase(cloned);
    __privateMethod(this, _Subgraph_instances, configureSubgraph_fn).call(this, cloned);
  }
  get rootGraph() {
    return __privateGet(this, _rootGraph);
  }
  getIoNodeOnPos(x2, y) {
  ...
  configure(data, keep_old) {
    ...
    __privateMethod(this, _Subgraph_instances, configureSubgraph_fn).call(this, data);
    return r;
  }
  attachCanvas(canvas2) {
  ...
  clone(keepId = false) {
    ...
    const subgraph = new _Subgraph(this.rootGraph, exported);
...
_rootGraph = new WeakMap();
_Subgraph_instances = new WeakSet();
configureSubgraph_fn = function(data) {
...
__publicField(_Subgraph, "MAX_NESTED_SUBGRAPHS", 1e3);
...
class InputIndicators {
  constructor(canvas2) {
    ...
    element.addEventListener("pointerdown", __privateGet(this, _onPointerDownOrMove), options);
    element.addEventListener("pointermove", __privateGet(this, _onPointerDownOrMove), options);
    element.addEventListener("pointerup", __privateGet(this, _onPointerUp), options);
    element.addEventListener("keydown", __privateGet(this, _onKeyDownOrUp), options);
    document.addEventListener("keyup", __privateGet(this, _onKeyDownOrUp), options);
...
class ContextMenu {
  ...
  constructor(values, options) {
    ...
    const ownerDocument = (_c = (_b = options.event) == null ? void 0 : _b.target) == null ? void 0 : _c.ownerDocument;
  ...
  containsNode(node2, visited = /* @__PURE__ */ new Set()) {
    ...
    visited.add(this);
    return ((_a = this.current_submenu) == null ? void 0 : _a.containsNode(node2, visited)) || this.root.contains(node2);
  }
  addItem(name, value, options) {
    ...
    if (value === null) {
      ...
      if (typeof value === "string") {
        ...
        element.innerHTML = (value == null ? void 0 : value.title) ?? innerHtml;
        if (value.disabled) {
          disabled = true;
    ...
    function inner_onclick(e2) {
      ...
      (_a = that.current_submenu) == null ? void 0 : _a.close(e2);
...
class LiteGraphGlobal {
  constructor() {
    ...
    __publicField(this, "NODE_FONT", "Arial");
    __publicField(this, "DEFAULT_FONT", "Arial");
    ...
    __publicField(this, "GROUP_FONT", "Arial");
    ...
    __publicField(this, "WIDGET_DISABLED_TEXT_COLOR", "#666");
     ...
     */
    __publicField(this, "alwaysRepeatWarnings", false);
    /**
     ...
     */
    __publicField(this, "onDeprecationWarning", [console.warn]);
    /**
     ...
     */
    __publicField(this, "macTrackpadGestures", false);
    /**
     ...
     */
    __publicField(this, "macGesturesRequireMac", true);
    /**
     ...
     * @default "legacy"
     */
    __publicField(this, "canvasNavigationMode", "legacy");
    /**
     ...
     * @default false
     */
    __publicField(this, "truncateWidgetTextEvenly", false);
    /**
  ...
  registerNodeAndSlotType(type, slot_type, out) {
    ...
    for (let slotType of allTypes) {
      ...
      register[slotType] ?? (register[slotType] = { nodes: [] });
...
class ExecutableNodeDTO {
  constructor(node2, subgraphNodePath, nodesByExecutionId, subgraphNode) {
    __privateAdd(this, _ExecutableNodeDTO_instances);
    ...
    if (!node2.graph) throw new NullGraphError();
    __privateSet(this, _id, [...this.subgraphNodePath, this.node.id].join(":"));
    ...
    if (this.node.applyToGraph) {
      this.applyToGraph = (...args) => {
        var _a, _b;
        return (_b = (_a = this.node).applyToGraph) == null ? void 0 : _b.call(_a, ...args);
      };
    }
  }
  /**
  ...
  get subgraphId() {
    var _a;
    return (_a = this.subgraphNode) == null ? void 0 : _a.subgraph.id;
  }
  ...
  resolveInput(slot, visited = /* @__PURE__ */ new Set()) {
    var _a;
    const uniqueId = `${(_a = this.subgraphNode) == null ? void 0 : _a.subgraph.id}:${this.node.id}[I]${slot}`;
  ...
  resolveOutput(slot, type, visited) {
    var _a;
    const uniqueId = `${(_a = this.subgraphNode) == null ? void 0 : _a.subgraph.id}:${this.node.id}[O]${slot}`;
    if (visited.has(uniqueId)) {
      const nodeInfo = `${this.node.id}${this.node.title ? ` (${this.node.title})` : ""}`;
      const pathInfo = this.subgraphNodePath.length > 0 ? ` at path ${this.subgraphNodePath.join(":")}` : "";
      throw new RecursionError(
    ...
    if (this.mode === LGraphEventMode.BYPASS) {
      ...
      const matchingIndex = indexes.find((i) => {
        var _a2;
        return ((_a2 = inputs[i]) == null ? void 0 : _a2.type) === type;
      });
    ...
    if (node2.isSubgraphNode()) return __privateMethod(this, _ExecutableNodeDTO_instances, resolveSubgraphOutput_fn).call(this, slot, type, visited);
...
_id = new WeakMap();
_ExecutableNodeDTO_instances = new WeakSet();
/**
 ...
 */
resolveSubgraphOutput_fn = function(slot, type, visited) {
  const { node: node2 } = this;
...
class SubgraphNode extends LGraphNode {
  constructor(graph, subgraph, instanceData) {
    ...
    __privateAdd(this, _SubgraphNode_instances);
    __publicField(this, "type");
    __publicField(this, "isVirtualNode", true);
    __publicField(this, "widgets", []);
    /** Manages lifecycle of all subgraph event listeners */
    __privateAdd(this, _eventAbortController, new AbortController());
    this.graph = graph;
    this.subgraph = subgraph;
    const subgraphEvents = this.subgraph.events;
    const { signal } = __privateGet(this, _eventAbortController);
    subgraphEvents.addEventListener("input-added", (e2) => {
      ...
      __privateMethod(this, _SubgraphNode_instances, addSubgraphInputListeners_fn).call(this, subgraphInput, input);
    }, { signal });
  ...
  configure(info) {
    var _a;
    for (const input of this.inputs) {
      (_a = input._listenerController) == null ? void 0 : _a.abort();
    }
    this.inputs.length = 0;
    this.inputs.push(
  ...
  _internalConfigureAfterSlots() {
    ...
    for (const input of this.inputs) {
      ...
      for (const linkId of subgraphInput.linkIds) {
        ...
        if (!widget) continue;
        __privateMethod(this, _SubgraphNode_instances, setWidget_fn).call(this, subgraphInput, input, widget);
        break;
      }
    }
  }
...
_SubgraphNode_instances = new WeakSet();
addSubgraphInputListeners_fn = function(subgraphInput, input) {
  var _a;
  (_a = input._listenerController) == null ? void 0 : _a.abort();
...
setWidget_fn = function(subgraphInput, input, widget) {
...
class GraphEditorAdapter {
   ...
   */
  destroy() {
    throw new Error("GraphEditorAdapter#destroy not implemented");
  }
}
const LG_TYPE_PREFIX = "storyflow/";
function lgTypeName(sfType) {
  return `${LG_TYPE_PREFIX}${sfType}`;
}
function sfTypeName(lgType) {
  return (lgType == null ? void 0 : lgType.startsWith(LG_TYPE_PREFIX)) ? lgType.slice(LG_TYPE_PREFIX.length) : lgType;
}
function toLiteGraph(model) {
  var _a, _b, _c, _d;
  const modelNodes = (model == null ? void 0 : model.nodes) ?? {};
  const modelEdges = Array.isArray(model == null ? void 0 : model.edges) ? model.edges : [];
  const numId = /* @__PURE__ */ new Map();
  let nextNum = 1;
  const nodes = [];
  for (const node2 of Object.values(modelNodes)) {
    const num = nextNum++;
    numId.set(node2.id, num);
    const { in: inPins, out: outPins } = pinsForType(node2.type, node2.data);
    const lgNode = {
      id: num,
      type: lgTypeName(node2.type),
      title: node2.name || humanizeType(node2.type),
      pos: [node2.x ?? 0, node2.y ?? 0],
      inputs: inPins.map((name) => ({ name, type: "flow", link: null })),
      outputs: outPins.map((name) => ({ name, type: "flow", links: [] })),
      properties: { sfId: node2.id, sfType: node2.type, sfName: node2.name ?? "", data: node2.data ?? {} }
    };
    const w = Number((_a = node2.data) == null ? void 0 : _a.w);
    const h = Number((_b = node2.data) == null ? void 0 : _b.h);
    if (Number.isFinite(w) && Number.isFinite(h) && w > 0 && h > 0) lgNode.size = [w, h];
    nodes.push(lgNode);
  }
  const byNum = new Map(nodes.map((n) => [n.id, n]));
  const links = [];
  const edgeIds = {};
  let nextLink = 1;
  for (const edge of modelEdges) {
    const srcNum = numId.get((_c = edge == null ? void 0 : edge.source) == null ? void 0 : _c.node);
    const tgtNum = numId.get((_d = edge == null ? void 0 : edge.target) == null ? void 0 : _d.node);
    if (srcNum == null || tgtNum == null) continue;
    const srcNode = byNum.get(srcNum);
    const tgtNode = byNum.get(tgtNum);
    const srcSlot = srcNode.outputs.findIndex((o) => o.name === edge.source.pin);
    const tgtSlot = tgtNode.inputs.findIndex((i) => i.name === edge.target.pin);
    if (srcSlot < 0 || tgtSlot < 0) continue;
    const linkId = nextLink++;
    links.push([linkId, srcNum, srcSlot, tgtNum, tgtSlot, "flow"]);
    srcNode.outputs[srcSlot].links.push(linkId);
    tgtNode.inputs[tgtSlot].link = linkId;
    edgeIds[linkId] = edge.id;
  }
  const groups = (Array.isArray(model == null ? void 0 : model.groups) ? model.groups : []).map((g) => ({
    id: g.id,
    title: g.title ?? "",
    bounding: [g.x ?? 0, g.y ?? 0, g.width ?? 200, g.height ?? 120],
    color: g.color ?? "",
    font_size: 24
  }));
  return {
...
function fromLiteGraph(serialized) {
  var _a, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p;
  const lgNodes = Array.isArray(serialized == null ? void 0 : serialized.nodes) ? serialized.nodes : [];
  const lgLinks = Array.isArray(serialized == null ? void 0 : serialized.links) ? serialized.links : [];
  const lgGroups = Array.isArray(serialized == null ? void 0 : serialized.groups) ? serialized.groups : [];
  const edgeIds = ((_b = (_a = serialized == null ? void 0 : serialized.extra) == null ? void 0 : _a.storyflow) == null ? void 0 : _b.edgeIds) ?? {};
  const meta = ((_d = (_c = serialized == null ? void 0 : serialized.extra) == null ? void 0 : _c.storyflow) == null ? void 0 : _d.meta) ?? {};
  const byNum = /* @__PURE__ */ new Map();
  const nodes = {};
  for (const lg of lgNodes) {
    const sfId = ((_e = lg.properties) == null ? void 0 : _e.sfId) ?? String(lg.id);
    const sfType = ((_f = lg.properties) == null ? void 0 : _f.sfType) ?? sfTypeName(lg.type);
    nodes[sfId] = {
      id: sfId,
      type: sfType,
      name: ((_g = lg.properties) == null ? void 0 : _g.sfName) ?? "",
      x: ((_h = lg.pos) == null ? void 0 : _h[0]) ?? 0,
      y: ((_i = lg.pos) == null ? void 0 : _i[1]) ?? 0,
      data: ((_j = lg.properties) == null ? void 0 : _j.data) ?? {}
    };
    byNum.set(lg.id, lg);
  }
  const edges = [];
  for (const link of lgLinks) {
    ...
    const [linkId, srcNum, srcSlot, tgtNum, tgtSlot] = link;
    const srcNode = byNum.get(srcNum);
    const tgtNode = byNum.get(tgtNum);
    if (!srcNode || !tgtNode) continue;
    const srcPin = (_l = (_k = srcNode.outputs) == null ? void 0 : _k[srcSlot]) == null ? void 0 : _l.name;
    const tgtPin = (_n = (_m = tgtNode.inputs) == null ? void 0 : _m[tgtSlot]) == null ? void 0 : _n.name;
    if (srcPin == null || tgtPin == null) continue;
    edges.push({
      id: edgeIds[linkId] ?? `link_${linkId}`,
      source: { node: ((_o = srcNode.properties) == null ? void 0 : _o.sfId) ?? String(srcNum), pin: srcPin },
      target: { node: ((_p = tgtNode.properties) == null ? void 0 : _p.sfId) ?? String(tgtNum), pin: tgtPin }
    });
  }
  const groups = lgGroups.map((g) => {
    const b = Array.isArray(g == null ? void 0 : g.bounding) ? g.bounding : [0, 0, 200, 120];
    return {
      id: String((g == null ? void 0 : g.id) ?? foundryRandomId()),
      title: (g == null ? void 0 : g.title) ?? "",
      x: b[0] ?? 0,
      y: b[1] ?? 0,
      width: b[2] ?? 200,
      height: b[3] ?? 120,
      color: (g == null ? void 0 : g.color) ?? ""
    };
  });
...
const ENABLED_PILL_RECT = { x: 10, y: 6, w: 52, h: 18 };
function glowColor(enabled) {
  return enabled ? "#37d67a" : "#e04848";
}
function drawTriggerGlow(ctx, width2, height, enabled) {
  const accent = glowColor(enabled);
  ctx.save();
  ctx.shadowColor = accent;
  ctx.shadowBlur = 12;
  ctx.strokeStyle = accent;
  ctx.lineWidth = 1.5;
  ctx.strokeRect(0.5, 0.5, width2 - 1, height - 1);
  ctx.restore();
}
function drawEnabledPill(ctx, rect, enabled) {
  const accent = glowColor(enabled);
  ctx.save();
  ...
  ctx.textAlign = "center";
  ctx.textBaseline = "middle";
  ctx.fillText(enabled ? "ON" : "OFF", rect.x + rect.w / 2, rect.y + rect.h / 2 + 0.5);
  ctx.restore();
}
function hitTestPill(rect, pos) {
  return pos[0] >= rect.x && pos[0] <= rect.x + rect.w && pos[1] >= rect.y && pos[1] <= rect.y + rect.h;
}
function toggleNodeEnabled(node2) {
  var _a, _b, _c, _d, _e;
  const data = ((_a = node2.properties) == null ? void 0 : _a.data) ?? (node2.properties.data = {});
  data.enabled = data.enabled === false;
  (_c = (_b = node2.graph) == null ? void 0 : _b.onAfterChange) == null ? void 0 : _c.call(_b);
  (_e = (_d = node2.graph) == null ? void 0 : _d._sfNotifyNodeDataChanged) == null ? void 0 : _e.call(_d, node2);
  node2.setDirtyCanvas(true, true);
}
let _registered = false;
function registerStoryflowNodes(LiteGraph2) {
  if (_registered) return;
  const LGraphNode2 = LiteGraph2.LGraphNode ?? globalThis.LGraphNode;
  for (const [type, def] of Object.entries(NODE_TYPES)) {
    if (type === "comment") {
      registerCommentNode(LiteGraph2);
      continue;
    }
    const lgType = lgTypeName(type);
    const color = nodeColor(type);
    const staticOut = def.pins.out === "dynamic" ? [] : def.pins.out;
    const inputs = def.pins.in;
    const isToggleTrigger = def.category === "trigger" && type !== "trigger.start";
    const NodeClass = class StoryflowNode extends LGraphNode2 {
      constructor(title) {
        super(title);
        this.title = humanizeType(type);
        this.color = color;
        this.bgcolor = "#2a2a2a";
        for (const name of inputs) this.addInput(name, "flow");
      ...
      onDrawForeground(ctx) {
        ...
        const enabled = ((_c = (_b = this.properties) == null ? void 0 : _b.data) == null ? void 0 : _c.enabled) !== false;
    ...
    NodeClass.title = humanizeType(type);
    LiteGraph2.registerNodeType(lgType, NodeClass);
  }
  _registered = true;
}
function ensurePlaceholderNode(LiteGraph2, sfType) {
  var _a;
  if (isKnownNodeType(sfType)) return;
  const lgType = lgTypeName(sfType);
  if ((_a = LiteGraph2.registered_node_types) == null ? void 0 : _a[lgType]) return;
  const LGraphNode2 = LiteGraph2.LGraphNode ?? globalThis.LGraphNode;
  const NodeClass = class StoryflowMissingNode extends LGraphNode2 {
    constructor(title) {
      super(title);
      this.title = `⚠ ${sfType}`;
      this.color = "#555555";
      ...
      this.properties = { sfId: "", sfType, data: {} };
    }
  };
  LiteGraph2.registerNodeType(lgType, NodeClass);
}
function jumpLinksToDraw(nodes) {
  const out = [];
  for (const [id, node2] of Object.entries(nodes ?? {})) {
    if ((node2 == null ? void 0 : node2.type) !== "jump") continue;
    const data = node2.data ?? {};
    const to = data.targetNodeId;
    if (!data.showLink || !to || to === id || !nodes[to]) continue;
    out.push({ from: id, to });
  }
  return out;
}
function anchorOnRect(rect, towardX, towardY) {
...
function disposeLiteGraphCanvas({ canvas: canvas2, graph } = {}) {
  var _a, _b, _c;
  if (canvas2) {
    canvas2.pause_rendering = true;
    (_a = canvas2.stopRendering) == null ? void 0 : _a.call(canvas2);
  }
  (_b = graph == null ? void 0 : graph.stop) == null ? void 0 : _b.call(graph);
  if (canvas2 && graph) (_c = graph.detachCanvas) == null ? void 0 : _c.call(graph, canvas2);
}
function screenToGraph([x2, y], view) {
  const { scale = 1, offset = [0, 0] } = view ?? {};
  return [x2 / scale - offset[0], y / scale - offset[1]];
}
registerStoryflowNodes(LiteGraph);
const GroupClass = LiteGraph.LGraphGroup;
if ((GroupClass == null ? void 0 : GroupClass.prototype) && !GroupClass.prototype.__sfFrameOnly) {
  const origMove = GroupClass.prototype.move;
  GroupClass.prototype.move = function move(dx, dy) {
    origMove.call(this, dx, dy, true);
  };
  GroupClass.prototype.recomputeInsideNodes = function recomputeInsideNodes() {
    var _a;
    this._nodes.length = 0;
    (_a = this._children) == null ? void 0 : _a.clear();
  };
  GroupClass.prototype.__sfFrameOnly = true;
}
class LiteGraphAdapter extends GraphEditorAdapter {
  constructor() {
    super(...arguments);
    __privateAdd(this, _LiteGraphAdapter_instances);
    /** @type {LGraph|null} */
    __privateAdd(this, _graph, null);
    /** @type {LGraphCanvas|null} */
    __privateAdd(this, _canvas2, null);
    /** @type {HTMLCanvasElement|null} */
    __privateAdd(this, _canvasEl, null);
    /** @type {HTMLElement|null} */
    __privateAdd(this, _host, null);
    /** @type {((e: object) => void)|null} */
    __privateAdd(this, _onChange, null);
    /** @type {((id: string|null) => void)|null} */
    __privateAdd(this, _onSelect, null);
    /** @type {((point: {x: number, y: number}) => void)|null} */
    __privateAdd(this, _onRequestAddNode, null);
    /** @type {((group: {id: string, title: string, color: string}) => void)|null} */
    __privateAdd(this, _onRequestEditGroup, null);
    /** @type {((info: {mode: string, x: number, y: number, graphPt: {x: number, y: number}}) => void)|null} */
    __privateAdd(this, _onRequestContextMenu, null);
    /** @type {((e: MouseEvent) => void)|null} */
    __privateAdd(this, _contextMenuHandler, null);
    /** @type {((e: Event) => void)|null} */
    __privateAdd(this, _dblClickHandler, null);
  ...
  init(hostEl) {
    ...
    canvasEl.className = "storyflow-graph-canvas";
    ...
    __privateSet(this, _graph, new LGraph());
    __privateSet(this, _canvas2, new LGraphCanvas(canvasEl, __privateGet(this, _graph)));
    __privateGet(this, _canvas2).background_image = null;
    __privateGet(this, _canvas2).bgcanvas = canvasEl;
    __privateGet(this, _canvas2).bgctx = null;
    __privateGet(this, _canvas2).onRender = (_c, ctx) => {
      const dpr = window.devicePixelRatio || 1;
      ctx.setTransform(dpr, 0, 0, dpr, 0, 0);
    };
    __privateGet(this, _canvas2).onDrawForeground = (ctx) => __privateMethod(this, _LiteGraphAdapter_instances, drawOverlays_fn).call(this, ctx);
    __privateMethod(this, _LiteGraphAdapter_instances, watchDpr_fn).call(this);
    __privateGet(this, _canvas2).allow_searchbox = false;
    __privateGet(this, _canvas2).processContextMenu = () => {
    };
    __privateGet(this, _canvas2).pasteFromClipboard = () => {
    };
    const fire = (type, node2) => {
      var _a, _b;
      return (_b = __privateGet(this, _onChange)) == null ? void 0 : _b.call(this, { type, nodeId: (_a = node2 == null ? void 0 : node2.properties) == null ? void 0 : _a.sfId });
    };
    __privateGet(this, _graph).onNodeAdded = (n) => fire("nodeAdded", n);
    __privateGet(this, _graph).onNodeRemoved = (n) => fire("nodeRemoved", n);
    __privateGet(this, _graph).onConnectionChange = () => fire("connectionChange");
    __privateGet(this, _graph).onAfterChange = () => fire("change");
    __privateGet(this, _graph)._sfNotifyNodeDataChanged = (n) => fire("nodeDataChanged", n);
    __privateGet(this, _canvas2).onNodeSelected = (n) => {
      var _a, _b;
      return (_b = __privateGet(this, _onSelect)) == null ? void 0 : _b.call(this, ((_a = n == null ? void 0 : n.properties) == null ? void 0 : _a.sfId) ?? null);
    };
    __privateGet(this, _canvas2).onNodeDeselected = () => {
      var _a;
      return (_a = __privateGet(this, _onSelect)) == null ? void 0 : _a.call(this, null);
    };
    __privateSet(this, _dblClickHandler, (event) => {
      var _a, _b, _c, _d, _e, _f;
      if (((_a = event.detail) == null ? void 0 : _a.subType) === "group-double-click") {
        const g = event.detail.group;
        if (g && __privateGet(this, _onRequestEditGroup)) {
          __privateGet(this, _onRequestEditGroup).call(this, { id: String(g.id), title: g.title ?? "", color: g.color ?? "" });
        }
        return;
      }
      if (((_b = event.detail) == null ? void 0 : _b.subType) !== "empty-double-click" || !__privateGet(this, _onRequestAddNode)) return;
      const orig = event.detail.originalEvent ?? event;
      const view = { scale: (_d = (_c = __privateGet(this, _canvas2)) == null ? void 0 : _c.ds) == null ? void 0 : _d.scale, offset: (_f = (_e = __privateGet(this, _canvas2)) == null ? void 0 : _e.ds) == null ? void 0 : _f.offset };
      let gx;
      let gy;
      if (Number.isFinite(orig.offsetX) && Number.isFinite(orig.offsetY)) {
        [gx, gy] = screenToGraph([orig.offsetX, orig.offsetY], view);
      } else if (Number.isFinite(orig.canvasX)) {
        gx = orig.canvasX;
        gy = orig.canvasY;
      } else {
        return;
      }
      __privateGet(this, _onRequestAddNode).call(this, { x: gx, y: gy });
    });
    __privateGet(this, _canvasEl).addEventListener("litegraph:canvas", __privateGet(this, _dblClickHandler));
    __privateSet(this, _contextMenuHandler, (event) => {
      var _a, _b, _c, _d, _e, _f;
      event.preventDefault();
      if (!__privateGet(this, _graph) || !__privateGet(this, _canvas2)) return;
      const view = { scale: (_a = __privateGet(this, _canvas2).ds) == null ? void 0 : _a.scale, offset: (_b = __privateGet(this, _canvas2).ds) == null ? void 0 : _b.offset };
      const [gx, gy] = screenToGraph([event.offsetX, event.offsetY], view);
      const node2 = ((_d = (_c = __privateGet(this, _graph)).getNodeOnPos) == null ? void 0 : _d.call(_c, gx, gy)) ?? (__privateGet(this, _graph)._nodes ?? []).find((n) => {
        var _a2;
        return (_a2 = n.isPointInside) == null ? void 0 : _a2.call(n, gx, gy);
      });
      const info = { mode: "empty", x: event.offsetX, y: event.offsetY, graphPt: { x: gx, y: gy } };
      if (node2) {
        const sfId = (_e = node2.properties) == null ? void 0 : _e.sfId;
        if (sfId && !this.getSelectedIds().includes(sfId)) this.selectNodes([sfId]);
        info.mode = "node";
        info.nodeId = sfId ?? null;
      }
      (_f = __privateGet(this, _onRequestContextMenu)) == null ? void 0 : _f.call(this, info);
    });
    __privateGet(this, _canvasEl).addEventListener("contextmenu", __privateGet(this, _contextMenuHandler));
  }
  loadGraph(model) {
    var _a;
    if (!__privateGet(this, _graph)) return;
    for (const node2 of Object.values((model == null ? void 0 : model.nodes) ?? {})) {
      ensurePlaceholderNode(LiteGraph, node2.type);
    }
    __privateGet(this, _graph).configure(toLiteGraph(model));
    for (const node2 of __privateGet(this, _graph)._nodes ?? []) {
      if (node2.preserveSizeOnLoad) continue;
      if (typeof node2.computeSize === "function" && typeof node2.setSize === "function") {
  ...
  serialize() {
    if (!__privateGet(this, _graph)) return { nodes: {}, edges: [], meta: {} };
    return fromLiteGraph(__privateGet(this, _graph).serialize());
  }
  addNode(type, x2, y) {
    var _a;
    if (!__privateGet(this, _graph)) return "";
    const node2 = LiteGraph.createNode(lgTypeName(type));
    if (!node2) return "";
    const sfId = foundry.utils.randomID(16);
    const data = cleanPayload(type);
    if (type === "trigger.timer") {
      const d = dateFromWorldTime(Number(((_a = game.time) == null ? void 0 : _a.worldTime) ?? 0));
      Object.assign(data, {
        anchorYear: d.year,
        anchorMonth: String(d.month),
        anchorDay: d.day,
        anchorHour: d.hour
      });
    }
    node2.properties = { sfId, sfType: type, sfName: "", data };
    node2.title = humanizeType(type);
    node2.pos = [x2, y];
    __privateGet(this, _graph).add(node2);
    return sfId;
  }
  removeNode(id) {
    var _a;
  ...
  deleteSelected() {
    ...
    for (const node2 of Object.values(selected)) (_b = __privateGet(this, _graph)) == null ? void 0 : _b.remove(node2);
    for (const item of ((_c = __privateGet(this, _canvas2)) == null ? void 0 : _c.selectedItems) ?? []) {
      if (item instanceof LiteGraph.LGraphGroup) (_d = __privateGet(this, _graph)) == null ? void 0 : _d.remove(item);
    }
  ...
  disconnectSelected() {
    ...
    for (const node2 of selected) {
      ...
      for (let i = 0; i < inputs.length; i += 1) {
        if (((_b = inputs[i]) == null ? void 0 : _b.link) != null) node2.disconnectInput(i);
      }
      const outputs = node2.outputs ?? [];
      for (let o = 0; o < outputs.length; o += 1) {
        if ((_d = (_c = outputs[o]) == null ? void 0 : _c.links) == null ? void 0 : _d.length) node2.disconnectOutput(o);
      }
    }
  ...
  getSelectedIds() {
    var _a;
    const selected = ((_a = __privateGet(this, _canvas2)) == null ? void 0 : _a.selected_nodes) ?? {};
    return Object.values(selected).map((n) => {
      var _a2;
      return (_a2 = n == null ? void 0 : n.properties) == null ? void 0 : _a2.sfId;
    }).filter(Boolean);
  }
  /**
  ...
  selectNodes(ids) {
    var _a, _b;
    if (!__privateGet(this, _canvas2) || !__privateGet(this, _graph)) return;
    const wanted = new Set(ids ?? []);
    const nodes = (__privateGet(this, _graph)._nodes ?? []).filter((n) => {
      var _a2;
      return wanted.has((_a2 = n.properties) == null ? void 0 : _a2.sfId);
    });
    (_b = (_a = __privateGet(this, _canvas2)).deselectAll) == null ? void 0 : _b.call(_a);
    if (nodes.length) __privateGet(this, _canvas2).selectNodes(nodes);
  ...
  listNodes() {
    var _a;
    return (((_a = __privateGet(this, _graph)) == null ? void 0 : _a._nodes) ?? []).map((n) => {
      var _a2, _b, _c;
      return { id: (_a2 = n.properties) == null ? void 0 : _a2.sfId, type: (_b = n.properties) == null ? void 0 : _b.sfType, name: ((_c = n.properties) == null ? void 0 : _c.sfName) ?? "" };
    }).filter((n) => n.id);
  }
  /**
  ...
  focusNode(id) {
    const node2 = __privateMethod(this, _LiteGraphAdapter_instances, findBySfId_fn).call(this, id);
    if (!node2 || !__privateGet(this, _canvas2)) return;
    __privateGet(this, _canvas2).centerOnNode(node2);
    this.selectNodes([id]);
  }
  /**
  ...
  focusGroup(id) {
    var _a, _b, _c, _d, _e;
    const group = (((_a = __privateGet(this, _graph)) == null ? void 0 : _a._groups) ?? []).find((g) => String(g.id) === String(id));
    if (!group || !__privateGet(this, _canvas2)) return;
    __privateGet(this, _canvas2).centerOnNode(group);
    try {
      (_c = (_b = __privateGet(this, _canvas2)).deselectAll) == null ? void 0 : _c.call(_b);
      (_e = (_d = __privateGet(this, _canvas2)).select) == null ? void 0 : _e.call(_d, group);
      __privateGet(this, _canvas2).setDirty(true, true);
    } catch {
    }
  }
  ...
  addGroup({ x: x2, y, title = "Group", color = "#335577" } = {}) {
    ...
    group.id = foundry.utils.randomID(16);
    group.pos = [Math.round(x2 ?? 0), Math.round(y ?? 0)];
    group.size = [240, 160];
    group.color = color;
    __privateGet(this, _graph).add(group);
    (_a = __privateGet(this, _onChange)) == null ? void 0 : _a.call(this, { type: "groupAdded" });
   ...
   */
  updateGroup(id, { title, color } = {}) {
    var _a, _b, _c;
    const group = (((_a = __privateGet(this, _graph)) == null ? void 0 : _a._groups) ?? []).find((g) => String(g.id) === String(id));
    if (!group) return;
    if (typeof title === "string") group.title = title;
    if (typeof color === "string") group.color = color;
    (_b = __privateGet(this, _onChange)) == null ? void 0 : _b.call(this, { type: "groupUpdated" });
    (_c = __privateGet(this, _canvas2)) == null ? void 0 : _c.setDirty(true, true);
  }
  setNodeOutputs(id, outPins) {
    var _a, _b;
    const node2 = __privateMethod(this, _LiteGraphAdapter_instances, findBySfId_fn).call(this, id);
    if (!node2) return;
    for (let i = (((_a = node2.outputs) == null ? void 0 : _a.length) ?? 0) - 1; i >= 0; i--) {
      if (!outPins.includes(node2.outputs[i].name)) node2.removeOutput(i);
    }
    const have = new Set((node2.outputs ?? []).map((o) => o.name));
    for (const name of outPins) {
      if (!have.has(name)) node2.addOutput(name, "flow");
    }
    (_b = __privateGet(this, _canvas2)) == null ? void 0 : _b.setDirty(true, true);
  }
  /**
  ...
  getNode(id) {
    ...
    return {
      id,
      type: node2.properties.sfType,
      name: node2.properties.sfName ?? "",
      data: foundry.utils.deepClone(node2.properties.data ?? {})
    };
  }
  /**
  ...
  setNodeData(id, data) {
    const node2 = __privateMethod(this, _LiteGraphAdapter_instances, findBySfId_fn).call(this, id);
    if (!node2) return;
    const type = node2.properties.sfType;
    node2.properties.data = data;
    const { out } = pinsForType(type, data);
  ...
  setNodeName(id, name) {
    ...
    const node2 = __privateMethod(this, _LiteGraphAdapter_instances, findBySfId_fn).call(this, id);
    if (!node2) return;
    node2.properties.sfName = name;
    node2.title = name || humanizeType(node2.properties.sfType);
    (_a = __privateGet(this, _canvas2)) == null ? void 0 : _a.setDirty(true, true);
  }
  /**
  ...
  getViewCenter() {
    var _a;
    if (!__privateGet(this, _canvasEl) || !((_a = __privateGet(this, _canvas2)) == null ? void 0 : _a.ds)) return null;
    const [x2, y] = screenToGraph(
      [__privateGet(this, _canvasEl).clientWidth / 2, __privateGet(this, _canvasEl).clientHeight / 2],
      { scale: __privateGet(this, _canvas2).ds.scale, offset: __privateGet(this, _canvas2).ds.offset }
    );
    return { x: x2, y };
  }
  /**
  ...
  clientToGraph(clientX, clientY) {
    var _a;
    if (!__privateGet(this, _canvasEl) || !((_a = __privateGet(this, _canvas2)) == null ? void 0 : _a.ds)) return null;
    const rect = __privateGet(this, _canvasEl).getBoundingClientRect();
    const [x2, y] = screenToGraph([clientX - rect.left, clientY - rect.top], {
      scale: __privateGet(this, _canvas2).ds.scale,
      offset: __privateGet(this, _canvas2).ds.offset
    });
    return { x: x2, y };
  }
  /**
  ...
  panBy(dxScreen, dyScreen) {
    var _a;
    const ds = (_a = __privateGet(this, _canvas2)) == null ? void 0 : _a.ds;
    if (!ds) return;
    ds.offset[0] += dxScreen / ds.scale;
    ds.offset[1] += dyScreen / ds.scale;
    __privateGet(this, _canvas2).setDirty(true, true);
  }
  onChange(cb) {
    __privateSet(this, _onChange, cb);
  }
  onSelect(cb) {
    __privateSet(this, _onSelect, cb);
  }
  onRequestAddNode(cb) {
    __privateSet(this, _onRequestAddNode, cb);
  }
  onRequestEditGroup(cb) {
    __privateSet(this, _onRequestEditGroup, cb);
  }
  onRequestContextMenu(cb) {
    __privateSet(this, _onRequestContextMenu, cb);
  }
  resize() {
    __privateMethod(this, _LiteGraphAdapter_instances, applyCanvasSize_fn).call(this);
  }
  ...
  destroy() {
    var _a;
    try {
      if (__privateGet(this, _canvasEl) && __privateGet(this, _dblClickHandler)) {
        __privateGet(this, _canvasEl).removeEventListener("litegraph:canvas", __privateGet(this, _dblClickHandler));
      }
      ...
      disposeLiteGraphCanvas({ canvas: __privateGet(this, _canvas2), graph: __privateGet(this, _graph) });
    } catch (err) {
      console.warn("storyflow-dungeons-lab | adapter destroy", err);
    }
    __privateSet(this, _dprMedia, null);
    __privateSet(this, _onDprChange, null);
    __privateSet(this, _dblClickHandler, null);
    __privateSet(this, _onRequestAddNode, null);
    __privateSet(this, _onRequestEditGroup, null);
    if (__privateGet(this, _contextMenuHandler) && __privateGet(this, _canvasEl)) {
      __privateGet(this, _canvasEl).removeEventListener("contextmenu", __privateGet(this, _contextMenuHandler));
    }
    __privateSet(this, _contextMenuHandler, null);
    __privateSet(this, _onRequestContextMenu, null);
    (_a = __privateGet(this, _canvasEl)) == null ? void 0 : _a.remove();
    __privateSet(this, _graph, null);
  ...
  setHoverHighlight(id) {
    var _a;
    const next = id || null;
    if (__privateGet(this, _hoverId) === next) return;
    __privateSet(this, _hoverId, next);
    (_a = __privateGet(this, _canvas2)) == null ? void 0 : _a.setDirty(true, true);
  }
}
_graph = new WeakMap();
...
_onRequestAddNode = new WeakMap();
_onRequestEditGroup = new WeakMap();
_onRequestContextMenu = new WeakMap();
_contextMenuHandler = new WeakMap();
_dblClickHandler = new WeakMap();
_dprMedia = new WeakMap();
_onDprChange = new WeakMap();
...
applyCanvasSize_fn = function() {
  var _a, _b;
  if (!__privateGet(this, _canvasEl) || !__privateGet(this, _host)) return;
  const dpr = window.devicePixelRatio || 1;
  const cssW = __privateGet(this, _host).clientWidth || 800;
  const cssH = __privateGet(this, _host).clientHeight || 600;
  __privateGet(this, _canvasEl).style.width = `${cssW}px`;
  __privateGet(this, _canvasEl).style.height = `${cssH}px`;
  const w = Math.max(1, Math.round(cssW * dpr));
  const h = Math.max(1, Math.round(cssH * dpr));
  if (__privateGet(this, _canvas2)) {
    const unchanged = ((_a = __privateGet(this, _canvas2).canvas) == null ? void 0 : _a.width) === w && ((_b = __privateGet(this, _canvas2).canvas) == null ? void 0 : _b.height) === h;
    __privateGet(this, _canvas2).resize(w, h);
    if (!unchanged) __privateGet(this, _canvas2).draw(true, true);
  } else {
    __privateGet(this, _canvasEl).width = w;
...
watchDpr_fn = function() {
  ...
  __privateSet(this, _dprMedia, window.matchMedia(`(resolution: ${window.devicePixelRatio}dppx)`));
  __privateSet(this, _onDprChange, () => {
    var _a;
    __privateMethod(this, _LiteGraphAdapter_instances, applyCanvasSize_fn).call(this);
    (_a = __privateGet(this, _canvas2)) == null ? void 0 : _a.setDirty(true, true);
    __privateMethod(this, _LiteGraphAdapter_instances, watchDpr_fn).call(this);
...
drawOverlays_fn = function(ctx) {
  var _a, _b, _c, _d, _e;
  if (!__privateGet(this, _graph)) return;
  const nodes = __privateGet(this, _graph)._nodes ?? [];
  const byId = /* @__PURE__ */ new Map();
  const model = {};
  for (const n of nodes) {
    const id = (_a = n.properties) == null ? void 0 : _a.sfId;
    if (!id) continue;
    byId.set(id, n);
    model[id] = { id, type: (_b = n.properties) == null ? void 0 : _b.sfType, data: (_c = n.properties) == null ? void 0 : _c.data };
  }
  const scale = ((_e = (_d = __privateGet(this, _canvas2)) == null ? void 0 : _d.ds) == null ? void 0 : _e.scale) || 1;
  const links = jumpLinksToDraw(model);
  if (links.length) {
    ctx.save();
    ...
    for (const { from, to } of links) {
      ...
      const b = byId.get(to);
      if (!a || !b) continue;
      const ra = __privateMethod(this, _LiteGraphAdapter_instances, nodeRect_fn).call(this, a);
      const rb = __privateMethod(this, _LiteGraphAdapter_instances, nodeRect_fn).call(this, b);
      const ca = { x: ra.x + ra.w / 2, y: ra.y + ra.h / 2 };
      const cb = { x: rb.x + rb.w / 2, y: rb.y + rb.h / 2 };
      const p1 = anchorOnRect(ra, cb.x, cb.y);
      const p2 = anchorOnRect(rb, ca.x, ca.y);
      ctx.beginPath();
      ctx.moveTo(p1.x, p1.y);
      ctx.lineTo(p2.x, p2.y);
      ctx.stroke();
      __privateMethod(this, _LiteGraphAdapter_instances, drawArrowhead_fn).call(this, ctx, p1, p2, scale);
    }
    ctx.restore();
  }
  if (__privateGet(this, _hoverId)) {
    const n = byId.get(__privateGet(this, _hoverId));
    if (n) {
      const r = __privateMethod(this, _LiteGraphAdapter_instances, nodeRect_fn).call(this, n);
      const pad = 4;
      ctx.save();
 ...
 * @returns {object|null}
 */
findBySfId_fn = function(sfId) {
  var _a;
  const nodes = ((_a = __privateGet(this, _graph)) == null ? void 0 : _a._nodes) ?? [];
  return nodes.find((n) => {
    var _a2;
    return ((_a2 = n.properties) == null ? void 0 : _a2.sfId) === sfId;
  }) ?? null;
};
export {
  LiteGraphAdapter
